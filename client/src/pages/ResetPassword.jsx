...
{!isEmailSent && 
      <form onSubmit={onSumbitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
        ...
        <button type="submit" className="w-full py-2.5 bg-linear-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3">Submit</button>
      </form>
}     
...
{!isOtpSubmitted && isEmailSent &&
      <form onSubmit={onSubmitOtp} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button type='submit' className='w-full py-2.5 bg-linear-to-r from-indigo-500 to-indigo-900 text-white rounded-full'>
          Submit</button>
      </form>
}
